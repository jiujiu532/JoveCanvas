            ...
            <div className="grid gap-5 p-4 lg:grid-cols-[minmax(0,1fr)_360px] sm:p-5">
                <div className="space-y-5">
                    ...
                    <div className="rounded-lg border border-stone-200 bg-stone-50/70 p-4 dark:border-stone-800 dark:bg-stone-900/40">
                        <SectionTitle icon={<BadgeCheck className="size-4" />} title={t("siteSettings.brandAdvanced")} />
                        <div className="mt-1 text-xs leading-5 text-stone-500 dark:text-stone-400">{t("siteSettings.brandAdvancedHint")}</div>
                        <div className="mt-4 grid gap-4 md:grid-cols-2">
                            <LabeledControl label={t("siteSettings.membershipProductName")}>
                            ...
                            <LabeledControl label={t("siteSettings.canvasProjectPrefix")}>
                            ...
                            <LabeledControl label={t("siteSettings.mailBrandName")}>
                            ...
                            <LabeledControl label={t("siteSettings.repoUrl")}>
                            ...
                            <LabeledControl label={t("siteSettings.updateCheckUrl")}>
                                ...
                                <div className="min-w-0 space-y-4">
                                    ...
                                    <div className="grid gap-3">
                                        ...
                                        <SettingToggle
                                            ...
                                            unCheckedChildren={t("systemSettings.off")}
                                ...
                                <div className="min-w-0 border-t border-stone-200 pt-4 xl:border-l xl:border-t-0 xl:pl-5 xl:pt-0 dark:border-stone-800">
                                    ...
                                    <div className="mt-4 grid gap-3">
                                        ...
                                        <div className="grid gap-3 sm:grid-cols-[minmax(0,1fr)_auto]">
                                            ...
                                            <SettingInlineToggle title="SSL" checked={settings.mail.secure} checkedChildren={t("systemSettings.on")} unCheckedChildren={t("systemSettings.off")} onChange={(secure) => updateMailSetting("secure", secure)} />
                                        </div>
