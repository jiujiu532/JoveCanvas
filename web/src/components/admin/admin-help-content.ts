...
export const adminHelpArticles: AdminHelpArticle[] = [
    {
        ...
        steps: [
            ...
            {
                title: "配置站点和模型能力",
                description: "先设置站点名称与JoveCanvas Logo，再配置上游渠道、逻辑模型和默认文本模型。",
    ...
    },
    {
        ...
        steps: [
            {
                title: "维护站点资料和品牌",
                description: "设置站点名称、SEO、社交入口、首页展示和JoveCanvas Logo；浏览器图标与助手头像使用同一品牌来源。",
        ...
        checks: ["站点所有品牌入口使用JoveCanvas Logo", "注册、验证码和找回密码流程与 SMTP 状态一致", "注销和升级操作都有可追踪记录"],
