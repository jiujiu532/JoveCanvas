...
export function UpdateCenterPanel() {
    ...
    const releaseLinks = [
        { label: "Release", href: "https://github.com/jiujiu532/JoveCanvas/releases", description: t("updates.releaseLinks.release") },
        { label: "Issues", href: "https://github.com/jiujiu532/JoveCanvas/issues", description: t("updates.releaseLinks.issues") },
        { label: "Docs", href: "https://github.com/jiujiu532/JoveCanvas", description: t("updates.releaseLinks.docs") },
    ];
                    ...
                    <div className="overflow-hidden rounded-3xl border border-stone-200/80 bg-stone-950 text-white shadow-sm shadow-stone-950/10 dark:border-stone-800 dark:bg-white dark:text-stone-950">
                        <div className="grid gap-3 p-4 sm:gap-6 sm:p-6 lg:grid-cols-[minmax(0,1fr)_220px]">
                            <div className="min-w-0">
                                <div className="text-xs font-semibold uppercase tracking-[0.16em] text-white/55 dark:text-stone-500">JoveCanvas Update</div>
