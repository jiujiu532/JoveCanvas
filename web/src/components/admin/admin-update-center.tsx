...
export function UpdateCenterPanel() {
    const releaseLinks = [
        { label: "Release", href: "https://github.com/jiujiu532/JoveCanvas/releases", description: "查看正式版本包和升级说明" },
        { label: "Issues", href: "https://github.com/jiujiu532/JoveCanvas/issues", description: "提交问题、部署异常和功能建议" },
        { label: "Docs", href: "https://github.com/jiujiu532/JoveCanvas", description: "查看开源仓库与部署入口" },
    ];
