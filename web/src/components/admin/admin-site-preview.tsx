...
// 静态元数据：供尚未接线 i18n 的调用方做 key/icon 回退；展示文案请用 useSiteSocialItems
...
export function useSiteSocialItems(): Array<{ key: SiteSocialKey; label: string; placeholder: string; icon: ReactNode }> {
    ...
    return [
        { key: "email", label: t("siteSettings.socialEmail"), placeholder: "mailto:csyqlz@gmail.com", icon: <Mail className="size-4" /> },
