    ...
    return (
        <div className="flex h-full flex-col overflow-hidden bg-background text-stone-800 dark:text-stone-100">
            <main ref={scrollContainerRef} className="min-h-0 flex-1 overflow-y-auto bg-background px-3 py-3 sm:px-6 sm:py-8">
                <div className="mx-auto max-w-7xl">
                    <div>
                        ...
                        <p className="mt-1.5 text-xs leading-5 text-stone-500 sm:mt-2 sm:text-sm dark:text-stone-400">{t("subtitlePlain")}</p>
                    </div>
            ...
            <PromptDetailDialog
                ...
                onCopy={(prompt) => copyText(prompt, t("promptCopied"))}
