...
export const PROFILE_SECTION_KEYS: ProfileSectionKey[] = ["overview", "profile", "billing", "orders", "consume", "points", "security"];
        ...
        <section className="rounded-lg border border-border bg-card p-2 text-card-foreground sm:rounded-2xl sm:p-6">
            <div className="flex items-start justify-between gap-3">
                <div className="min-w-0">
                    <h2 className="text-lg font-semibold tracking-tight text-stone-950 sm:text-xl dark:text-white">{t("billingCenterTitle")}</h2>
    ...
    return (
        <div className="max-w-2xl">
            <div className="rounded-xl border border-stone-200 bg-stone-50/80 p-3 text-sm leading-6 text-stone-700 dark:border-stone-800 dark:bg-stone-900/70 dark:text-stone-200">
                <div className="font-medium">{boundEmail ? t("emailBound") : t("emailUnbound")}</div>
                <div className="mt-1 break-all text-stone-500 dark:text-stone-400">{boundEmail || t("emailUnboundHint")}</div>
            </div>
