...
export function DramaAssetsPanel({ project }: { project: DramaProject }) {
    ...
    const generateReference = async (item: DramaNamedAsset) => {
        ...
        try {
            ...
            appendReference(item, { id: `reference-${nanoid()}`, url, source: "generated", label: t("assets.generatedCandidateLabel"), width: result.width, height: result.height, createdAt: new Date().toISOString() });
