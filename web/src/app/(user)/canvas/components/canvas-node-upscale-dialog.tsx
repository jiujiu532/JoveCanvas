...
export function CanvasNodeUpscaleDialog({ dataUrl, open, onClose, onConfirm }: { dataUrl: string; open: boolean; onClose: () => void; onConfirm: (params: CanvasImageUpscaleParams) => void }) {
    ...
    const algorithms = useMemo(
        () =>
            [
                { value: "high" as const, title: t("upscale.highTitle"), description: t("upscale.highDesc") },
                { value: "bilinear" as const, title: t("upscale.bilinearTitle"), description: t("upscale.bilinearDesc") },
                { value: "nearest" as const, title: t("upscale.nearestTitle"), description: t("upscale.nearestDesc") },
            ] satisfies Array<{ value: ImageUpscaleAlgorithm; title: string; description: string }>,
        [t],
    );
