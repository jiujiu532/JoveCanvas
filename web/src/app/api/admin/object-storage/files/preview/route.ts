...
export async function GET(request: Request) {
    ...
    try {
        ...
        if (!url) return NextResponse.json({ code: 404, data: null, msg: await serverMessage("admin.imageNotFound") }, { status: 404 });
        ...
        return NextResponse.json({ code: 500, data: null, msg: await serverMessage("admin.externalImagePreviewFailed") }, { status: 500 });
    }
}
